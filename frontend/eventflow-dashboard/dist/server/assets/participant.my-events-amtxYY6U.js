import { W as React, X as jsxRuntimeExports, r as reactExports } from "./server-qdE1tQQu.js";
import { P as ProtectedRoute } from "./ProtectedRoute-DaPVQkRl.js";
import { D as DashboardLayout, G as registrationsApi, p as PageHeader, C as Card, r as Badge, b as Calendar, O as Dialog, V as DialogTrigger, B as Button, Q as QrCode, W as DialogContent, X as DialogHeader, Y as DialogTitle } from "./router-UDsI4_WY.js";
...
function MyEvents() {
  const [myEvents, setMyEvents] = reactExports.useState([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "My events", description: "Your registered events and QR tickets." }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-10", children: "Loading your events..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: myEvents.length > 0 ? myEvents.map((registration) => /* @__PURE__ */ jsxRuntimeExports.jsx(TicketCard, { registration }, registration._id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-full text-center text-muted-foreground py-10", children: "No registered events found." }) })
  ] });
}
function TicketCard({
  registration
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden shadow-card border-border/60 flex flex-col sm:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:w-32 h-32 sm:h-auto shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: event.image, alt: event.title, className: "w-full h-full object-cover" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex-1 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "self-start", children: event.category || "Event" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mt-2 leading-tight", children: event.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-2 space-y-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "gradient-primary text-primary-foreground border-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Your check-in ticket" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white p-4 rounded-xl shadow-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QRCodeSVG, { value: JSON.stringify({
              registrationId: registration._id,
              name: registration.user?.name || "Participant"
            }), size: 200 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold", children: event.title }),
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { roles: ["participant", "admin"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MyEvents, {}) }) });
export {
