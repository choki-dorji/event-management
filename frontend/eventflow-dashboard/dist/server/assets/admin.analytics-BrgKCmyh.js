...
import { c as createLucideIcon, N as clsx, D as DashboardLayout, p as PageHeader, U as Users, b as Calendar } from "./router-UDsI4_WY.js";
import { S as StatCard, a as SectionCard } from "./StatCard-DdtE2-ET.js";
import { a as attendanceTrend, e as eventCategoryStats } from "./mockData-CMg32f5D.js";
import { c as createSelector, q as selectChartLayout, aW as selectChartDataWithIndexesIfNotInPanoramaPosition4, aj as selectAxisWithScale, am as selectTicksOfGraphicalItem, aq as selectUnfilteredCartesianItems, ao as isCategoricalAxis, ap as getBandSizeOfAxis, as as propsAreEqual, D as resolveDefaultProps, E as DefaultZIndexes, at as useIsPanorama, G as RegisterGraphicalItemId, au as SetLegendPayload, av as SetCartesianGraphicalItem, A as getTooltipNameProp, N as SetTooltipEntrySettings, ax as noop, aA as useNeedsClip, aB as usePlotArea, ay as useChartLayout, J as useAppSelector, aC as isClipDot, Z as ZIndexLayer, M as Layer, aD as GraphicalItemClipPath, j as getValueByDataKey, aE as getCateCoordinateOfLine, aG as isNullish, O as useAnimationId, P as JavascriptAnimate, U as interpolate, a9 as LabelListFromLabelProp, aI as CartesianLabelListContextProvider, aJ as svgPropertiesAndEvents, a8 as Shape, F as svgPropertiesNoEvents, aV as CartesianChart, aU as arrayTooltipSearcher, T as TrendingUp, R as ResponsiveContainer, C as CartesianGrid, X as XAxis, Y as YAxis, a as Tooltip, L as Legend } from "./CartesianChart-BYScwybi.js";
import { S as SetErrorBarContext, B as BarChart, a as Bar } from "./BarChart-DbO5Fpwv.js";
...
function Analytics() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Analytics", description: "Deep dive into platform performance." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "DAU", value: "1,284", icon: Activity, gradient: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "WAU", value: "3,602", icon: Users }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Events this month", value: 18, icon: Calendar }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Growth", value: "+24%", icon: TrendingUp, trend: "vs last month" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionCard, { title: "Attendance breakdown", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: attendanceTrend, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "present", stackId: "a", fill: "oklch(0.52 0.21 270)", radius: [0, 0, 0, 0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "absent", stackId: "a", fill: "oklch(0.78 0.15 200)", radius: [6, 6, 0, 0] })
      ] }) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionCard, { title: "Categories performance", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: eventCategoryStats, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", opacity: 0.3 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "value", stroke: "oklch(0.55 0.24 305)", strokeWidth: 3, dot: {
          r: 5,
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { roles: ["admin"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Analytics, {}) }) });
export {
