import { a9 as requireShim, c as createLucideIcon, N as clsx, aa as reactDomExports } from "./router-UDsI4_WY.js";
import { O as requireReact, r as reactExports, S as getDefaultExportFromCjs, a5 as commonjsGlobal, a4 as React } from "./server-qdE1tQQu.js";
...
var DefaultLegendContent = (outsideProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("ul", {
    ...
    style: finalStyle
  }, /* @__PURE__ */ reactExports.createElement(Items, _extends$j({}, props, {
    payload
  })));
};
var uniqBy$3 = {};
...
function LegendImpl(outsideProps) {
  ...
  }), /* @__PURE__ */ reactExports.createElement(LegendContent, _extends$h({}, props, widthOrHeight, {
    margin,
    chartWidth,
    chartHeight,
    contextPayload
...
var DefaultTooltipContent = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("div", _extends$g({
    className: wrapperCN,
    style: finalStyle
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$f({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$d({}, otherPathProps, {
      x: round$1(x2),
      y: round$1(y2),
      width: round$1(width),
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$d({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
...
function Cursor(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(CursorInternal, _extends$b({}, props, {
    offset,
    layout,
    tooltipAxisBandSize,
    chartName
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$a({}, svgPropertiesAndEvents(textProps), {
    ref,
    x: x2,
    y: y2,
...
var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$9({}, attrs, {
...
function Label(outerProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex: props.zIndex
  }, /* @__PURE__ */ reactExports.createElement(Text, _extends$9({
    ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (label && typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$9({}, label, {
      key: "label-implicit"
    }, commonProps));
  }
  return null;
...
function LabelListFromLabelProp(_ref2) {
  ...
  if (typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(LabelList, _extends$8({
      key: "labelList-implicit"
    }, label, {
...
export {
  selectActiveTooltipIndex as $,
  getTooltipNameProp as A,
  selectChartOffsetInternal as B,
  CartesianGrid as C,
  resolveDefaultProps as D,
  DefaultZIndexes as E,
  svgPropertiesNoEvents as F,
  RegisterGraphicalItemId as G,
  findAllByType as H,
  Cell as I,
  useAppSelector as J,
  ...
  Legend as L,
  Layer as M,
  SetTooltipEntrySettings as N,
  useAnimationId as O,
  JavascriptAnimate as P,
  get$1 as Q,
  ...
  YAxis as Y,
  ZIndexLayer as Z,
  PolarLabelListContextProvider as _,
  Tooltip as a,
  selectBarCategoryGap as a$,
  selectActiveTooltipDataKey as a0,
  selectActiveTooltipGraphicalItemId as a1,
  useMouseEnterItemDispatch as a2,
  useMouseLeaveItemDispatch as a3,
  useMouseClickItemDispatch as a4,
  DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME as a5,
  DATA_ITEM_INDEX_ATTRIBUTE_NAME as a6,
  adaptEventsOfChild as a7,
  Shape as a8,
  LabelListFromLabelProp as a9,
  useNeedsClip as aA,
  usePlotArea as aB,
  isClipDot as aC,
  GraphicalItemClipPath as aD,
  getCateCoordinateOfLine as aE,
  useCartesianChartLayout as aF,
  isNullish as aG,
  isNan as aH,
  CartesianLabelListContextProvider as aI,
  svgPropertiesAndEvents as aJ,
  isWellBehavedNumber as aK,
  useAppDispatch as aL,
  updatePolarOptions as aM,
  RechartsStoreProvider as aN,
  ChartDataContextProvider as aO,
  ReportMainChartProps as aP,
  ReportEventSettings as aQ,
  ReportChartProps as aR,
  CategoricalChart as aS,
  initialEventSettingsState as aT,
  arrayTooltipSearcher as aU,
  CartesianChart as aV,
  selectChartDataWithIndexesIfNotInPanoramaPosition4 as aW,
  isStacked as aX,
  selectAxisViewBox as aY,
  selectRootMaxBarSize as aZ,
  selectBarGap as a_,
  getMaxRadius as aa,
  getPercentValue as ab,
  polarToCartesian as ac,
  svgPropertiesNoEventsFromUnknown as ad,
  Curve as ae,
  getClassNameFromUnknown as af,
  Text as ag,
  selectChartDataWithIndexesIfNotInPanoramaPosition3 as ah,
  selectChartBaseValue as ai,
  selectAxisWithScale as aj,
  selectXAxisIdFromGraphicalItemId as ak,
  selectYAxisIdFromGraphicalItemId as al,
  selectTicksOfGraphicalItem as am,
  getStackSeriesIdentifier as an,
  isCategoricalAxis as ao,
  getBandSizeOfAxis as ap,
  selectUnfilteredCartesianItems as aq,
  selectStackGroups as ar,
  propsAreEqual as as,
  useIsPanorama as at,
  SetLegendPayload as au,
  SetCartesianGraphicalItem as av,
  getNormalizedStackId as aw,
  noop$2 as ax,
  useChartLayout as ay,
  useChartName as az,
  pickAxisId as b,
  selectRootBarSize as b0,
  selectCartesianAxisSize as b1,
  getBaseValueOfBar as b2,
  truncateByDomain as b3,
  getCateCoordinateOfBar as b4,
  adaptEventHandlers as b5,
  svgPropertiesAndEventsFromUnknown as b6,
  useActiveTooltipDataPoints as b7,
  createSelector as c,
  combineGraphicalItemsSettings as d,
  combineGraphicalItemsData as e,
  selectChartDataAndAlwaysIgnoreIndexes as f,
  combineDisplayedData as g,
  combineAppliedValues as h,
  itemAxisPredicate as i,
  getValueByDataKey as j,
  selectAllErrorBarSettings as k,
  selectChartDataSliceIgnoringIndexes as l,
  combineDomainOfAllAppliedNumericalValuesIncludingErrorValues as m,
  selectDomainDefinition as n,
  selectDomainFromUserPreference as o,
  pickAxisType as p,
  selectChartLayout as q,
  combineNumericalDomain as r,
  selectBaseAxis as s,
  selectStackOffsetType as t,
  combineAxisDomain as u,
  selectRenderableAxisSettings as v,
  selectRealScaleType as w,
  combineNiceTicks as x,
  combineAxisDomainWithNiceTicks as y,
  combineCheckedDomain as z
};
